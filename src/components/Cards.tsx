        ...
        <>
            <div className="w-full py-[10rem] px-4 bg-white">
                <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
                    <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 text-center">
                        <img src={SingleImage} alt="" className="w-20 mx-auto mt-[-3rem] bg-white" />
                    ...
                    <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 text-center">
                        <img src={DoubleImage} alt="" className="w-20 mx-auto mt-[-3rem] bg-white" />
                        <h2 className="text-2xl font-bold py-8">Single User</h2>
                        <p className=" text-4xl font-bold">$149</p>
                        <div className="font-medium">
                            <p className="py-2 border-b mx-8 mt-8">500 GB Storage</p>
                    ...
                    <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 text-center">
                        <img src={TripleImage} alt="" className="w-20 mx-auto mt-[-3rem] bg-white" />
                        <h2 className="text-2xl font-bold py-8">Single User</h2>
                        <p className=" text-4xl font-bold">$149</p>
                        <div className="font-medium">
                            <p className="py-2 border-b mx-8 mt-8">500 GB Storage</p>
